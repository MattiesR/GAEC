...
\author{\ReplaceMe{Group Member 1}, Julius Jacobitz, and Matties Roofthooft}
...
\subsection*{Figure: \ref{best_run_convergence} Zoomed}
\begin{figure}[H]
    \centering
...
\subsection*{Figure: Best value over all 100 random seeds}
\begin{figure}[H]
    \centering
